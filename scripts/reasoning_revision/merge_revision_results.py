#!/usr/bin/env python3
"""Merge revision results from multiple workers into single files.
...
Called by revision_master.sbatch after all workers complete.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Merge revision results from multiple workers"
    )
    parser.add_argument(
        "--input-dir",
        required=True,
